 ...
 *
 */
@WebServlet(name = "GeneratePdf1", urlPatterns = {"/GeneratePdf1"})
public class GeneratePdf1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                Logger.getLogger(GeneratePdf1.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//                    p.add("\n\n Bill Number - JAL" + division + "/" + id[i]);
                    ...
                    cell.setBorder(Rectangle.NO_BORDER);
                    cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                    //cell.setHorizontalAligat com.smp.jal.GeneratePdf1.processRequest(GeneratePdf1.java:409)nment(Element.ALIGN_RIGHT);
                    table.addCell(cell);
