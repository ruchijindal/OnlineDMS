					...
					Data Inserted Successfuly.
					 ...
					 Error ! tryagain.
                            ...
                            <form id="form" method="post" action="<%= request.getContextPath()%>/CreateUser">
                                ...
                                <p> <label class="form-label">FirstName</label>
                                    <input type="text" id="firstname" name="firstname" class="required"/></p>

                                <p><label class="form-label">LastName</label>
                                    <input type="text" id="lastname" name="lastname" ></p>

                                <p> <label class="form-label">User Role:</label>
                                    <select name="userrole" id="userrole" style="width: 145px;">
                                ...
                                <p> <label class="form-label">Division:</label>
                                    <select name="division" id="division" style="width: 145px;">
