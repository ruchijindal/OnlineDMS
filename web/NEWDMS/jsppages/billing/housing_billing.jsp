...
<% if (session.getAttribute("flag").equals("0")) {
                ...
                if (session.getAttribute("flag").equals("2")) {
                    ...
                    response.sendRedirect("/NEWDMS/GeneratePdf?division="+div+"&flag1=0");
                ...
                <div class="content-box column-left"><!-- Start Content Box -->
                    ...
                    <div class="content-box-content">
						...
						Javascript is disabled or is not supported by your browser. Please upgrade your browser or Enable Javascript in your browser.
                            ...
                            <form id="form3" action="CalculateBillForConsumer" name="form3"  >

                                <p>
                                    <label class="form-label">Consumer No</label>
                                    <input type="text" name="cons_no" id="cons_no" class="required" minlength="8" maxlength="9" onblur="checkMst('con_n_f')" onkeyup="clearUserID()" />
                ...
                <div class="content-box column-right ">
                    ...
                    <div class="content-box-content">
						...
						Javascript is disabled or is not supported by your browser. Please upgrade your browser or Enable Javascript in your browser.
                            ...
                            <form id="form4" name="form4" action="CalculateBillForSector"  onsubmit="getBillList()" >
