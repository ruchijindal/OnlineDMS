    ...
    <head> <title>Noida Jal Board : Home</title>
        ...
        <script type="text/javascript">
            ...
            { //document.getElementById("consno").style.display="none";
                ...
                var url="<%= request.getContextPath() %>/blockList"
                url=url+"?&sec="+sec;
            ...
            function showConsumerNo()
            {
                ...
                else
                {
                    ...
                    var url="<%= request.getContextPath() %>/showConsumerNo"
    ...
    <body>
        ...
        <div id="canvas1">
            <!--            <div id="header">
                            <div class="inside">
                                <div class="container">
                                    <div id="logo"><a href="#" title="noida_logo"><img src="resources/images/logo.png" alt="noida_logo"/></a></div>
            ...
            <%
                                        if (request.getAttribute("t1") != null) {
                                            ...
                                            if (t == 1) {
            %>
            <p class="errorcolor"><label>&nbsp;&nbsp;Invalid Username or Password </label></p>
            <%
                                                            t = (Integer) 0;
            ...
            <form action="login.jsp" method="post">
                <fieldset>
                    ...
                    <input value="User Name" name="userid" id="userid" onclick="this.value=''" />

                    <input value="Password" name="password" id="password" title="Please fill Your password !"  type="password" onclick="this.value=''" />
...
consumer
            ...
            <a href="jsppages/common/ch_pwd.jsp">Change Password</a>&nbsp;|&nbsp;

            <%}%>
            <a href="jsppages/common/logout.jsp">Logout</a> </div>
...
<div class="inside">
    <div class="container">
        <div class="leftcorners">
            ...
            %>
            <li><a href="jsppages/sitepages/rate.jsp" title="Rates">Rates</a></li>  #menu .popup
            <%                 }
            %>
            <li><a href="jsppages/sitepages/forms.jsp" title="Forms">Forms</a></li>
            <li class="popup"><a href="#" class="bor" title="Information">Information</a>
                <ul>
                    <li class="first"><a href="jsppages/sitepages/news_list.jsp" title="News">News</a></li>
                    <li><a href="jsppages/sitepages/notices.jsp" title="Notices">Notices</a></li>
                    <li><a href="jsppages/sitepages/services.jsp" title="Services">Services</a></li>
                    <li class="last"><a href="jsppages/sitepages/scheme.jsp" title="Schemes">Schemes</a></li>
                </ul>
            </li>
            ...
            %>
            <li class="bor"><a href="#">CRM area</a>
                <ul>

                    <li class="bo left"><a href="#">Contents</a>
                        <ul>

                 <li class="last"><a href="jsppages/admin/view_complains.jsp">Suggestions/Complains</a></li>
                        </ul>
                    </li>
            ...
            %>
            <li class="bor"><a href="#">Admin area</a>
                <ul>
                    <li class="first"> <a href="jsppages/admin/admin.jsp">DashBoard</a></li>
                    <li class="bo left"><a href="#">Contents</a>
                        <ul>
                            <li class="first"><a href="jsppages/admin/viewcontent.jsp">Manage Contents</a></li>
                            <li><a href="jsppages/admin/viewuploadfile.jsp">UploadedFiles</a></li>
                 s. It supports pause-on-hover, auto-stop, auto-fit, before/after callbacks, click triggers and much more. It also supports, but does not r           <li class="last"><a href="jsppages/admin/view_complains.jsp">Suggestions/Complains</a></li>
                        </ul>
                    </li>
                    <li class="bo left last"><a href="#">UserSettings</a>
                        <ul>
                            <li class="first"><a href="jsppages/admin/create_user.jsp">Create User</a></li>
                            <li class="last"><a href="jsppages/admin/view_user.jsp">View User</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="bor"><a href="#">Manager</a>
                <ul>
                    <li class="first"> <a href="jsppages/manager/mgr_dashboard.jsp">DashBoard</a></li>
                    <li class="bo left"><a href="#">Reports</a>
                        <ul>
                            <li class="first"><a href="jsppages/manager/revenue_report.jsp">Revenue Report</a></li>
                            <li class="last"><a href="jsppages/manager/cons_report.jsp">Consumer Report</a></li>
                        </ul>
                    </li>
                    <li class="bo left last"><a href="#">Graphs</a>
                        <ul>
                            <li class="first"><a href="jsppages/charts/Code/JSP/jal_chart.jsp">Revenue Graph</a></li>
                            <li class="last"><a href="jsppages/charts/Code/JSP/ConsumerChart.jsp">Consumer Graph</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="bor"><a href="#">Consumer </a>
                <ul>
                    <li class="first"><a href="jsppages/consumer/cons_details.jsp">Consumer Details</a></li>
                    <li class="last"><a href="jsppages/consumer/chl_details.jsp">Payment Details</a></li>
                </ul>
            </li>
            ...
            %>
            <li ><a href="jsppages/sitepages/page.jsp?con_id=<%=con_id%>"><%=con_title%></a></li>

            <%
                        }
                        if (session.isNew() && session.getAttribute("application").equals("OnlineJal")) {
                            Statement statement = con.createStatement();
                            statement.executeQuery("UPDATE hit_counter SET count = count + 1");
                        }
            %>
            <li><a href="jsppages/sitepages/contact.jsp" title="Contact Us">Contact Us</a></li>
        </ul>
    </div>
</div>
</div>
